...
import pic1 from "@/image/Food/yoshi1.png";
import pic2 from "@/image/Food/yoshi2.png";

export default function GalleryPage() {
  const images: StaticImageData[] = [pic1, pic2];
  ...
  return (
    <div className="min-h-screen bg-bgLogin relative">
      <header className="w-full bg-bgLogin text-white flex items-center gap-3 p-4 fixed top-0 left-0 z-20">
        ...
        <Link
          href="https://www.facebook.com/yoshimeatsudavao/"
          target="_blank"
          rel="noopener noreferrer"
        >
          <span className="text-sm text-black sm:text-sm pl-3 cursor-default">
            Photo Courtesy: <strong className="hover:text-red-500">Yoshimaetsu Davao (2025)</strong>
          </span>
        </Link>
      ...
      {/* GALLERY GRID */}
      <div className="min-h-screen w-full flex justify-center items-center px-6 pb-20">
        <div className="inline-block mt-14 sm:mt-10">
          <div
            className="grid gap-10 place-items-center grid-cols-1 sm:grid-cols-2"
          >
