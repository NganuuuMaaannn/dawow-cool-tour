...
import pic1 from "@/image/Food/rekado1.png";
import pic2 from "@/image/Food/rekado2.png";
import pic3 from "@/image/Food/rekado3.png";
  ...
  return (
    <div className="min-h-screen bg-bgLogin relative">
      <header className="w-full bg-bgLogin text-white flex items-center gap-3 p-4 fixed top-0 left-0 z-20">
        ...
        <Link
          href="https://www.facebook.com/rekadodavao/"
          target="_blank"
          rel="noopener noreferrer"
        >
          <span className="text-sm text-black sm:text-sm pl-3 cursor-default">
            Photo Courtesy: <strong className="hover:text-red-500">Rekado Filipino (2025)</strong>
          </span>
        </Link>
