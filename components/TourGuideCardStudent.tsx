...
export interface TourGuideStudent {
  student_name: string;
...
interface Props {
  guideStudent: TourGuideStudent;
}

export default function TourGuideCardStudent({ guideStudent }: Props) {
  return (
      ...
      <div className="flex flex-col gap-6 md:w-[300px] lg:w-[350px]">
        ...
        <div className="border-2 border-yellow-400 rounded-xl px-4 py-3 bg-bg shadow-sm flex items-center gap-3">
          ...
          <div>
            ...
            {guideStudent.student_phone.map((num, index) => (
